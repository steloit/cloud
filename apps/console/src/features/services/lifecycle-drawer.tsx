...
export function LifecycleDrawer({ svc, onClose }: { svc: Service; onClose: () => void }) {
  ...
  return (
    <Drawer
      ...
      sub={<>{svc.name} · Object Storage · rule 3</>}
      onClose={onClose}
      footer={
        <>
          <span className="text-10p5 text-ink3">Rule 3 of 3 · soft delete still applies 30 d</span>
    ...
    >
      ...
      <p className="text-11 leading-relaxed text-ink3">
        Same shape the assistant proposed in <span className="mono">prp_st77a4</span> (AI7) — this
        is the manual path to the identical rule.
      </p>
