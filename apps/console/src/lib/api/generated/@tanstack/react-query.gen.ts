 ...
 */
export const revokeInviteMutation = (options?: Partial<Options<RevokeInviteData>>): UseMutationOptions<RevokeInviteResponse, DefaultError, Options<RevokeInviteData>> => {
    const mutationOptions: UseMutationOptions<RevokeInviteResponse, DefaultError, Options<RevokeInviteData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const updateServiceMutation = (options?: Partial<Options<UpdateServiceData>>): UseMutationOptions<UpdateServiceResponse, UpdateServiceError, Options<UpdateServiceData>> => {
    const mutationOptions: UseMutationOptions<UpdateServiceResponse, UpdateServiceError, Options<UpdateServiceData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const forkDashboardMutation = (options?: Partial<Options<ForkDashboardData>>): UseMutationOptions<ForkDashboardResponse, DefaultError, Options<ForkDashboardData>> => {
    const mutationOptions: UseMutationOptions<ForkDashboardResponse, DefaultError, Options<ForkDashboardData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await forkDashboard({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const duplicateDashboardMutation = (options?: Partial<Options<DuplicateDashboardData>>): UseMutationOptions<DuplicateDashboardResponse, DefaultError, Options<DuplicateDashboardData>> => {
    const mutationOptions: UseMutationOptions<DuplicateDashboardResponse, DefaultError, Options<DuplicateDashboardData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await duplicateDashboard({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const deleteWidgetMutation = (options?: Partial<Options<DeleteWidgetData>>): UseMutationOptions<DeleteWidgetResponse, DefaultError, Options<DeleteWidgetData>> => {
    const mutationOptions: UseMutationOptions<DeleteWidgetResponse, DefaultError, Options<DeleteWidgetData>> = {
        mutationFn: async (fnOptions) => {
...
export const getDesiredStateQueryKey = (options: Options<GetDesiredStateData>) => createQueryKey('getDesiredState', options);
...
export const getDesiredStateOptions = (options: Options<GetDesiredStateData>) => queryOptions<GetDesiredStateResponse, GetDesiredStateError, GetDesiredStateResponse, ReturnType<typeof getDesiredStateQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getDesiredState({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getDesiredStateQueryKey(options)
});

/**
 * The cell confirms an environment's namespace is gone
 *
 ...
 */
export const postEnvironmentTeardownMutation = (options?: Partial<Options<PostEnvironmentTeardownData>>): UseMutationOptions<PostEnvironmentTeardownResponse, PostEnvironmentTeardownError, Options<PostEnvironmentTeardownData>> => {
    const mutationOptions: UseMutationOptions<PostEnvironmentTeardownResponse, PostEnvironmentTeardownError, Options<PostEnvironmentTeardownData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postEnvironmentTeardown({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const postReconcileStatusMutation = (options?: Partial<Options<PostReconcileStatusData>>): UseMutationOptions<PostReconcileStatusResponse, PostReconcileStatusError, Options<PostReconcileStatusData>> => {
    const mutationOptions: UseMutationOptions<PostReconcileStatusResponse, PostReconcileStatusError, Options<PostReconcileStatusData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postReconcileStatus({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
