...
- **bindings**(id, source_id, target_id, scope enum, status) — UNIQUE(source,target); FK ON DELETE RESTRICT (delete goes through typed-confirm listing dependents).
