...
import { GatewayModelsTab } from "@/features/services/gateway-tabs";
    ...
    <main className="main">
      <div className="pgpad !overflow-y-auto">
        {svc.product === "ai-gateway" ? (
          <GatewayModelsTab svc={svc} org={org} project={project} env={env} />
        ) : (
...
export const Route = createFileRoute("/_app/$org/$project/svc/$service/models")({
  component: TabRoute,
});
